...
export class VoxelGunApp {
  constructor() {
    ...
    this.animSequence = new AnimationSequence(this.animEngine, this.state, this.builder, GunModel);
  ...
  _goToStep(targetStep) {
    ...
    this.animSequence.goToStep(targetStep);
    this._refreshUI();
  }
